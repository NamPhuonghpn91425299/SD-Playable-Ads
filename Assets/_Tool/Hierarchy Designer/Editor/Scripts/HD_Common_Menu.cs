...
namespace Verpha.HierarchyDesigner
{
    internal static class HD_Common_Menu
    {
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Activate)]
        public static void MenuItem_Activate_DropdownTextMeshPro() => HD_Common_Operations.Activate_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>(true);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Activate)]
        public static void MenuItem_Activate_InputFieldTextMeshPro() => HD_Common_Operations.Activate_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>(true);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Deactivate)]
        public static void MenuItem_Deactivate_DropdownTextMeshPro() => HD_Common_Operations.Activate_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>(false);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Deactivate)]
        public static void MenuItem_Deactivate_InputFieldTextMeshPro() => HD_Common_Operations.Activate_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>(false);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Count)]
        public static void MenuItem_Count_DropdownTextMeshPro() => HD_Common_Operations.Count_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>("Dropdowns - TextMeshPro");

        [MenuItem(HD_Common_Constants.Count_UI + "/Count All Input Fields - TextMeshPro", false, HD_Common_Constants.MenuPriorityEleven + 8)]
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Count)]
        public static void MenuItem_Count_InputFieldTextMeshPro() => HD_Common_Operations.Count_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>("Input Fields - TextMeshPro");
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Lock)]
        public static void MenuItem_Lock_DropdownTextMeshPro() => HD_Common_Operations.Lock_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>(true);

        [MenuItem(HD_Common_Constants.Lock_UI + "/Lock All Input Fields - TextMeshPro", false, HD_Common_Constants.MenuPriorityEleven + 8)]
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Lock)]
        public static void MenuItem_Lock_InputFieldTextMeshPro() => HD_Common_Operations.Lock_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>(true);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Unlock)]
        public static void MenuItem_Unlock_DropdownTextMeshPro() => HD_Common_Operations.Lock_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>(false);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Unlock)]
        public static void MenuItem_Unlock_InputFieldTextMeshPro() => HD_Common_Operations.Lock_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>(false);
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Select)]
        public static void MenuItem_Select_DropdownTextMeshPro() => HD_Common_Operations.Select_AllTMPComponentIfAvailable<UnityEngine.UI.Dropdown>();
        ...
        [HD_Common_Attributes(HierarchyDesigner_Attribute_Tools.Select)]
        public static void MenuItem_Select_InputFieldTextMeshPro() => HD_Common_Operations.Select_AllTMPComponentIfAvailable<UnityEngine.UI.InputField>();
