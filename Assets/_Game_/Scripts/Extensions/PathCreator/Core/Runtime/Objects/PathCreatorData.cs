...
namespace PathCreation {
    ...
    public class PathCreatorData {
        ...
        // Get the vertex path in world space (not affected by transform)
        public VertexPath GetVertexPathWorldSpace () {
            // create new vertex path without transform to get world space coordinates
            return new VertexPath (bezierPath, null, vertexPathMaxAngleError, vertexPathMinVertexSpacing);
        }
