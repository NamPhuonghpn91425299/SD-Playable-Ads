...
public static class HeliExtension
{
    /// <summary>
    /// Lấy rotaspeed cần thiết để bay được tới điểm đến tránh trường hợp rota speed quá nhỏ không bay được tới nơi
    /// </summary>
    /// <param name="myTrans">transform của máy bay</param>
    /// <param name="targetPos">vị trí sẽ bay đến</param>
    /// <param name="currentMoveSpeed">tốc độ vay</param>
    /// <param name="campAngle"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// lấy angle của startPos so với endPos theo trục Y
    /// thuận chiều kim đồng hồ với 0 = y+
    ///  giá trị từ -180=>180
    /// </summary>
    /// <param name="startPos">Mốc</param>
    /// <param name="endPos">Vị trí so sánh</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// clamp angle truyền vào trong phạm vi -180--180
    /// </summary>
    /// <param name="angleInput"></param>
    /// <returns></returns>
